using CustomerValidator.ArchitectureTests.Infrastructure;
using CustomerValidator.Domain.Abstractions;
using FluentAssertions;
using NetArchTest.Rules;
using System.Reflection;

namespace CustomerValidator.ArchitectureTests.Domain;
